...
class Pelicula {
    ...
    public function insertarPelicula($linea){
        ...
        $sql = "INSERT INTO Pelicula (id_pelicula, titulo, id_director, id_genero,año) 
...
<body>
    ...
    <p>Introduce nombre para el .csv:
        <input type="text" name="archivo_exportar">
